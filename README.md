...
This repository will help you to train, validate and test FOV AI model for binary-class classification using retinal fundus images by employing deep learning (DL) methodology. 
