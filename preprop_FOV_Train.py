...
## Pre-process Diagnos training images and save as '.h5' format
...
PATH_CSV = './CSV_FOV/CSV_FOV_Train_V1/'
...
X_val = image_load('/home/mracine/FOV_Database/Train_FOV_Dataset/', val_x_img, 'origin')
#X_val = image_load('/home/mracine/FOV_Database/Train_FOV_Dataset/', val_x_img, 'clahe')
#X_val = image_load('/home/mracine/FOV_Database/Train_FOV_Dataset/', val_x_img, 'LAC')
...
with h5py.File("./prepro_FOV_Train_V1/Xy_Origin_FOV_Train_V1.h5", "w") as f:
#with h5py.File("./prepro_FOV_Train_V1/Xy_Clahe_FOV_Train_V1.h5", "w") as f:
#with h5py.File("./prepro_FOV_Train_V1/Xy_LAC_FOV_Train_V1.h5", "w") as f:
